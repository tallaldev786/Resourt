...
const destinations = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1565008576549-57569a49371d?q=80&w=2069",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1559128010-7c1ad6e1b6a5?q=80&w=2073",
  },
]
  ...
  return (
    <section id="destinations" className="py-20 lg:py-28 bg-white">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        {/* Destinations Grid - 5 columns like Jacada */}
          ...
          {destinations.map((destination) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5">
                <p className="text-xs text-white/70 mb-1 leading-tight">
