...
const footerLinks = {
  destinations: [
    { name: "Africa", href: "#" },
    { name: "Asia", href: "#" },
    { name: "Central Asia", href: "#" },
    { name: "Europe", href: "#" },
    { name: "Indian Subcontinent", href: "#" },
    { name: "Latin America", href: "#" },
    { name: "South Pacific", href: "#" },
  ],
  experiences: [
    { name: "Active Adventures", href: "#" },
    { name: "Family Journeys", href: "#" },
